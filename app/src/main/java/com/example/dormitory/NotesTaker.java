...
public class NotesTaker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            fio.setText(notes.getFio());
            roomnumber.setText(notes.getRoomnumber());
            addcom.setText(notes.getNotes());
            isOldNote = true;
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String gmtTime = String.valueOf(Calendar.getInstance(TimeZone.getTimeZone("UTC")).getTimeInMillis());
                if (!isOldNote){
                    notes = new Notes();
                }

                notes.setFio(fio1);
                notes.setNotes(addcom1);
                notes.setPlace(place);
                notes.setRoomnumber(roomnumber1);
                notes.setDate(gmtTime);
                ...
                NotesFB newUser= new NotesFB(id, fio1, Integer.parseInt(roomnumber1), addcom1, place, gmtTime);
